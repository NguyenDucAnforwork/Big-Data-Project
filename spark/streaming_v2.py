...
from pyspark.sql.functions import (
    col, from_json, window, count, when, lit, broadcast
)
...
def main():
    ...
    # 4. Load zone lookup and categorize into major zones
    try:
        ...
        # Join and create major zone categories
        ...
        # Categorize zones (customize based on your needs)
    ...
    # 5. Apply watermark and window aggregation
    ...
    def write_to_cassandra(batch_df, batch_id):
        ...
        logger.info(f"Batch {batch_id}: Writing {count} records to Cassandra")
        
        try:
            batch_df.write \
                .format("org.apache.spark.sql.cassandra") \
                .mode("append") \
                .options(table="trip_demand_by_zone_5m", keyspace=CASSANDRA_KEYSPACE) \
                .save()
    ...
    logger.info("Trip Demand by Zone streaming started...")
